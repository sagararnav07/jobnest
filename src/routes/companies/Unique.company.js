      ...
      {isLoading ? (
        ...
        <>
          <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
            ...
            <div className="ml-32">
              <img
                className="w-32 rounded shadow-lg lg:rounded-none lg:shadow-none"
          ...
          <div class="container  mx-auto md:px-6">
            <section class="mt-10 mb-10 text-center">
              <h2 class="mb-10 text-3xl font-bold">Our Features</h2>

              <div class="grid lg:grid-cols-3 lg:gap-x-12">
                <div class="mb-12 lg:mb-0">
                  <div class="block h-full rounded-lg bg-white s">
                    <div class="flex justify-center"></div>
                    <div class="p-6">
                      <h5 class="mb-4 text-lg font-semibold">Environment</h5>
                      <p>
                ...
                <div class="mb-12 lg:mb-0">
                  <div class="block h-full rounded-lg bg-white">
                    <div class="flex justify-center"></div>
                    <div class="p-6">
                      <h5 class="mb-4 text-lg font-semibold">Freindly</h5>
                      <p>
                ...
                <div class="">
                  <div class="block h-full rounded-lg bg-white">
                    <div class="flex justify-center"></div>
                    <div class="p-6">
                      <h5 class="mb-4 text-lg font-semibold">Learning</h5>
                      <p>
          ...
          <div className="px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="mx-auto mb-10 lg:max-w-xl sm:text-center">
              <h2 class="mb-10 text-3xl font-bold">Our Team</h2>
            </div>
            <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
              ...
              <div>
                ...
                <div className="flex flex-col sm:text-center">
                  <p className="text-lg font-bold">Asjedh</p>
              ...
              <div>
                ...
                <div className="flex flex-col sm:text-center">
                  <p className="text-lg font-bold">Nasmi</p>
              ...
              <div>
                ...
                <div className="flex flex-col sm:text-center">
                  <p className="text-lg font-bold">Nashan</p>
                  <p className="mb-5 text-xs text-gray-800">Manager</p>
                  <div className="flex items-center space-x-3 sm:justify-center"></div>
                </div>
              </div>
            </div>
          ...
          <div class="relative flex  justify-center  sm:items-center sm:pt-0">
            <div class="p-6 mr-2  sm:rounded-lg">
              <h2 class="text-center mb-10 text-3xl font-bold">
                Company Details
              </h2>

              <div class="flex items-center ">
                <MapPinIcon className="w-8 h-8 text-gray-500"></MapPinIcon>
              ...
              <div class="flex items-center mt-4">
                <PhoneIcon className="w-8 h-8 text-gray-500"></PhoneIcon>
                <div class="ml-4 text-md tracking-wide font-semibold w-40">
                  {company.userPhone}
                </div>
              </div>
              ...
              <div class="flex items-center mt-2">
                <EnvelopeIcon className="w-8 h-8 text-gray-500"></EnvelopeIcon>
                <div class="ml-4 text-md tracking-wide font-semibold w-40">
                  {company.email}
                </div>
              </div>
